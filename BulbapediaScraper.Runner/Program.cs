...
using BulbapediaScraper.Runner.Enums.MegaEvolutionList;
...
namespace BulbapediaScraper.Runner
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            ScrapePokemonEvolutionList(GetFullPath(POKEMON_EVOLUTION_LIST_PATH), pokemonList);

            ScrapeMegaEvolution(GetFullPath(POKEMON_MEGA_EVOLUTION_LIST_PATH), pokemonList);

            Console.WriteLine();
            Console.WriteLine("BulbapediaScraper was finalized");
        }

        private static ICollection<Pokemon> ScrapePokemonList(string url)
        {
        ...
        private static void ScrapePokemonEvolutionList(string url, ICollection<Pokemon> pokemonList)
        {
        ...
        private static void ScrapeMegaEvolution(string url, ICollection<Pokemon> pokemonList)
        {
            Console.WriteLine("Scraping: Mega evolution list");
        ...
        private static string GetMegaEvolutionName(string pokemonName, string megaStoneName)
        {
