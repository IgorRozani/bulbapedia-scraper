...
using BulbapediaScraper.Runner.Services.Scrapers.Services.PokemonList.Enums;
using HtmlAgilityPack;
using System.Collections.Generic;
using System.Linq;

namespace BulbapediaScraper.Runner.Services.Scrapers.Services.PokemonList
{
    public class PokemonList : BaseScraper, IPokemonList
    {
